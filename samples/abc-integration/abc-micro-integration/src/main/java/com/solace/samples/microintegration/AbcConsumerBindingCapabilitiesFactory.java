...
/**
 * A factory for creating {@link ConsumerBindingCapabilities} for abc consumer bindings.
 */
class AbcConsumerBindingCapabilitiesFactory implements ConsumerBindingCapabilitiesFactory {
  ...
  public ConsumerBindingCapabilities create(ConsumerProperties consumerProperties) {
    return new AbcConsumerBindingCapabilities(consumerProperties.getBindingName());
  }

  private static class AbcConsumerBindingCapabilities implements ConsumerBindingCapabilities {
    private final String bindingName;

    private AbcConsumerBindingCapabilities(String bindingName) {
